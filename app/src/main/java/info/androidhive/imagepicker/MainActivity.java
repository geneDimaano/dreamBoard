...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadProfile(String url,Integer resultCode) {
    ...
    @OnClick({R.id.img_plus1, R.id.img_profile1,R.id.img_plus2, R.id.img_profile2,R.id.img_plus3, R.id.img_profile3})
        ...
        if (requestCode == REQUEST_IMAGE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    loadProfile(uri.toString(),resultCode);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
